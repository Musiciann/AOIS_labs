...
if __name__ == "__main__":
    ...
    print("Multiply:")
    first_decimal = int(input("Enter №1 decimal >>> "))
    second_decimal = int(input("Enter №2 decimal >>> "))
    direct_binary = Binary_Operations.binary_multiply(Binary_Operations.decimal_to_binary_direct_code(first_decimal),
                                                      Binary_Operations.decimal_to_binary_direct_code(second_decimal))
